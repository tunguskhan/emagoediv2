...
def worker():
    ...
    from modules.sdxl_styles import apply_style, apply_wildcards, emagoediv_expansion, apply_arrays
    ...
    def handler(async_task):
        ...
        metadata_scheme = MetadataScheme(args.pop()) if not args_manager.args.disable_metadata else MetadataScheme.emagoediv
        ...
        if emagoediv_expansion in style_selections:
            use_expansion = True
            style_selections.remove(emagoediv_expansion)
        else:
            use_expansion = False
        ...
        if not skip_prompt_processing:
            ...
            if use_expansion:
                for i, t in enumerate(tasks):
                    progressbar(async_task, 5, f'Preparing emagoediv text #{i + 1} ...')
            ...
            try:
                ...
                for x in imgs:
                    d = [('Prompt', 'prompt', task['log_positive_prompt']),
                         ...
                         ('emagoediv V2 Expansion', 'prompt_expansion', task['expansion']),
                    ...
                    d.append(('Version', 'version', 'emagoediv v' + emagoediv_version.version))
