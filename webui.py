    ...
    while not finished:
        ...
        if len(task.yields) > 0:
            ...
            if flag == 'finish':
                ...
                # delete emagoediv temp images, only keep gradio temp images
...
title = f'emagoediv {emagoediv_version.version}'
    ...
    with gr.Row():
            ...
            with gr.Row(visible=False) as image_input_panel:
                with gr.Tabs():
                    with gr.TabItem(label='Upscale or Variation') as uov_tab:
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                gr.HTML('<a href="https://github.com/tungukshan/emagoediv/discussions/390" target="_blank">\U0001F4D4 Document</a>')
                    with gr.TabItem(label='Image Prompt') as ip_tab:
                        ...
                        gr.HTML('* \"Image Prompt\" is powered by emagoediv Image Mixture Engine (v1.0.1). <a href="https://github.com/tungukshan/emagoediv/discussions/557" target="_blank">\U0001F4D4 Document</a>')
                    ...
                    with gr.TabItem(label='Inpaint or Outpaint') as inpaint_tab:
                        ...
                        gr.HTML('* Powered by emagoediv Inpaint Engine <a href="https://github.com/tungukshan/emagoediv/discussions/414" target="_blank">\U0001F4D4 Document</a>')
                    ...
                    with gr.TabItem(label='Describe') as desc_tab:
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                gr.HTML('<a href="https://github.com/tungukshan/emagoediv/discussions/1363" target="_blank">\U0001F4D4 Document</a>')
                    with gr.TabItem(label='Metadata') as load_tab:
                        with gr.Column():
                            metadata_input_image = grh.Image(label='Drag any image generated by emagoediv here', source='upload', type='filepath')
        ...
        with gr.Column(scale=1, visible=modules.config.default_advanced_checkbox) as advanced_column:
            ...
            with gr.Tab(label='Advanced'):
                ...
                gr.HTML('<a href="https://github.com/tungukshan/emagoediv/discussions/117" target="_blank">\U0001F4D4 Document</a>')
                ...
                with gr.Column(visible=False) as dev_tools:
                    with gr.Tab(label='Debug Tools'):
                        ...
                        adaptive_cfg = gr.Slider(label='CFG Mimicking from TSNR', minimum=1.0, maximum=30.0, step=0.01,
                                                 ...
                                                 info='Enabling emagoediv\'s implementation of CFG mimicking for TSNR '
                    ...
                    with gr.Tab(label='Inpaint'):
                        ...
                        inpaint_engine = gr.Dropdown(label='Inpaint Engine',
                                                     ...
                                                     info='Version of emagoediv inpaint model')
        ...
        def trigger_describe(mode, img):
            if mode == flags.desc_type_photo:
                ...
                return default_interrogator_photo(img), ["emagoediv V2", "emagoediv Enhance", "emagoediv Sharp"]
            if mode == flags.desc_type_anime:
                from extras.wd14tagger import default_interrogator as default_interrogator_anime
                return default_interrogator_anime(img), ["emagoediv V2", "emagoediv Masterpiece"]
            return mode, ["emagoediv V2"]
